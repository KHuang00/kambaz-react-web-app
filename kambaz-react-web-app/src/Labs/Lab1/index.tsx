        ...
        <h2>Lab 1</h2>
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li> Unpack the Trader joe's frozen pan cake </li>
                    <li> Cook in toast oven for five minutes.</li>
                    <li> Flip and bake the other side for another five minutes. </li>
                    <li> Serve and enjoy!</li>
                </ol>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>Project Management for dummies</li>
                </ul>
            ...
            <div id="wd-tables">
                ...
                <table border={1} width="100%">
                    ...
                    <tfoot>
                    <tr>
                        <td align={"left"} colSpan={3}>Average</td>
                        <td>97</td>
                    </tr>
                    </tfoot>
                </table>
            ...
            <div id={"wd-forms"}>
                ...
                <form id="wd-text-fields">
                    ...
                    <input placeholder="k.huang" id="wd-text-fields-username" /> <br />
                    <label htmlFor="wd-text-fields-password">Password:</label>
                    <input type="password" value="123@#$asd" id="wd-text-fields-password" />
                    <br />
                    <label htmlFor="wd-text-fields-first-name">First name:</label>
                    <input type="text" title="John" value="Kat" id="wd-text-fields-first-name" /> <br />
                ...
                <input type="email"
                       placeholder="khuang@northeastern.edu"
